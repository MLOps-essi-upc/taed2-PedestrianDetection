...
# training_dataset = torch.utils.data.Subset(training_dataset, range(0, 50))      # Only used to train using a subset of the data (for testing purposes)
# validation_dataset = torch.utils.data.Subset(validation_dataset, range(0, 30))
