...
This module contains the code for testing the model performance using the test dataset.
"""
import configparser
import os
import sys
...
testing_dataset = torch.utils.data.Subset(testing_dataset, range(0, 1))
...
final_model = torch.load(os.path.join(root_dir, 'models/baseline_retrain.pth'), map_location=device)
